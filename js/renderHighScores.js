        ...
        return newArr
            .map((i, index) => {
               ...
               <div class="highscores__item-el"><span>#${index + 1}</span></div>
                <div class="highscores__item-el"><span>Player name:</span> ${i.name
                    }</div>
                <div class="highscores__item-el"><span>Grid size:</span> ${i.mode
                    }</div>
                <div class="highscores__item-el"><span>Steps:</span> ${i.steps
                    }</div>
